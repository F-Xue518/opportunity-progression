...
- Phase 4 Step 1 (Market Search): delegated to `Account Information` + `Solutions Search` skills; those skills may internally consume Interface #1 (Customer Reference)
- Phase 4 Step 2 (Compete): delegated to `Compete` skill; that skill may internally consume Interface #2 (Compete Intelligence) and Interface #3 (Win/Loss Data)
